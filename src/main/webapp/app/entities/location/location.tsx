    ...
    return (
      <div>
        <h2 id="location-heading">
          <Translate contentKey="systemProjectsApp.location.home.title">Locations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="systemProjectsApp.location.home.createLabel">Create new Location</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="systemProjectsApp.location.streetAddress">Street Address</Translate>
                </th>
                <th>
                  <Translate contentKey="systemProjectsApp.location.postalCode">Postal Code</Translate>
                </th>
                <th>
                  <Translate contentKey="systemProjectsApp.location.city">City</Translate>
                </th>
                <th>
                  <Translate contentKey="systemProjectsApp.location.stateProvince">State Province</Translate>
                </th>
                <th>
                  <Translate contentKey="systemProjectsApp.location.country">Country</Translate>
                </th>
                <th />
              </tr>
            </thead>
