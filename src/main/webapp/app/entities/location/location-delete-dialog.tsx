  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="systemProjectsApp.location.delete.question">
          <Translate contentKey="systemProjectsApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
