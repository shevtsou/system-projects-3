    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="systemProjectsApp.region.home.createOrEditLabel">
              <Translate contentKey="systemProjectsApp.region.home.createOrEditLabel">Create or edit a Region</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
