    ...
    return (
      <div>
        <h2 id="country-heading">
          <Translate contentKey="systemProjectsApp.country.home.title">Countries</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="systemProjectsApp.country.home.createLabel">Create new Country</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="systemProjectsApp.country.countryName">Country Name</Translate>
                </th>
                <th>
                  <Translate contentKey="systemProjectsApp.country.region">Region</Translate>
                </th>
                <th />
              </tr>
            </thead>
