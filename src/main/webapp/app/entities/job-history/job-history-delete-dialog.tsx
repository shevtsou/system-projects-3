  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="systemProjectsApp.jobHistory.delete.question">
          <Translate contentKey="systemProjectsApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
