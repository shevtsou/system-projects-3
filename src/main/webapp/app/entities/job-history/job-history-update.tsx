    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="systemProjectsApp.jobHistory.home.createOrEditLabel">
              <Translate contentKey="systemProjectsApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="startDateLabel" for="startDate">
                    <Translate contentKey="systemProjectsApp.jobHistory.startDate">Start Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="endDateLabel" for="endDate">
                    <Translate contentKey="systemProjectsApp.jobHistory.endDate">End Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="languageLabel">
                    <Translate contentKey="systemProjectsApp.jobHistory.language">Language</Translate>
                  </Label>
                  <AvInput
                  ...
                  >
                    <option value="FRENCH">
                      <Translate contentKey="systemProjectsApp.Language.FRENCH" />
                    </option>
                    <option value="ENGLISH">
                      <Translate contentKey="systemProjectsApp.Language.ENGLISH" />
                    </option>
                    <option value="SPANISH">
                      <Translate contentKey="systemProjectsApp.Language.SPANISH" />
                    </option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                  <Label for="job.id">
                    <Translate contentKey="systemProjectsApp.jobHistory.job">Job</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="department.id">
                    <Translate contentKey="systemProjectsApp.jobHistory.department">Department</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="employee.id">
                    <Translate contentKey="systemProjectsApp.jobHistory.employee">Employee</Translate>
                  </Label>
