    ...
    return (
      <div>
        <h2 id="department-heading">
          <Translate contentKey="systemProjectsApp.department.home.title">Departments</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="systemProjectsApp.department.home.createLabel">Create new Department</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="systemProjectsApp.department.departmentName">Department Name</Translate>
                </th>
                <th>
                  <Translate contentKey="systemProjectsApp.department.location">Location</Translate>
                </th>
                <th />
              </tr>
            </thead>
