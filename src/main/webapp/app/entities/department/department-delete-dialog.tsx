  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="systemProjectsApp.department.delete.question">
          <Translate contentKey="systemProjectsApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
