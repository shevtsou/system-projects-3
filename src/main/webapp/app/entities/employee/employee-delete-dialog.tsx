  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="systemProjectsApp.employee.delete.question">
          <Translate contentKey="systemProjectsApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
