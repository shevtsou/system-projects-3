    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="systemProjectsApp.employee.home.createOrEditLabel">
              <Translate contentKey="systemProjectsApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : employeeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="firstNameLabel" for="firstName">
                    <Translate contentKey="systemProjectsApp.employee.firstName">First Name</Translate>
                  </Label>
                  <AvField id="employee-firstName" type="text" name="firstName" />
                  <UncontrolledTooltip target="firstNameLabel">
                    <Translate contentKey="systemProjectsApp.employee.help.firstName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="lastNameLabel" for="lastName">
                    <Translate contentKey="systemProjectsApp.employee.lastName">Last Name</Translate>
                  </Label>
                  <AvField id="employee-lastName" type="text" name="lastName" />
                </AvGroup>
                <AvGroup>
                  <Label id="emailLabel" for="email">
                    <Translate contentKey="systemProjectsApp.employee.email">Email</Translate>
                  </Label>
                  <AvField id="employee-email" type="text" name="email" />
                </AvGroup>
                <AvGroup>
                  <Label id="phoneNumberLabel" for="phoneNumber">
                    <Translate contentKey="systemProjectsApp.employee.phoneNumber">Phone Number</Translate>
                  </Label>
                  <AvField id="employee-phoneNumber" type="text" name="phoneNumber" />
                </AvGroup>
                <AvGroup>
                  <Label id="hireDateLabel" for="hireDate">
                    <Translate contentKey="systemProjectsApp.employee.hireDate">Hire Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="salaryLabel" for="salary">
                    <Translate contentKey="systemProjectsApp.employee.salary">Salary</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="department.id">
                    <Translate contentKey="systemProjectsApp.employee.department">Department</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="manager.id">
                    <Translate contentKey="systemProjectsApp.employee.manager">Manager</Translate>
                  </Label>
